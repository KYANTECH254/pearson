...
e),!1}}
function Da(a,b,c){var d,e=null===(d=Ba(a))||void 0===d?void 0:d.open(a.H.aa,a.H.VERSION);if(null==e)return"function"===typeof c&&c(),!1;e.onupgradeneeded=function(f){var g;a.J.info("Upgrading indexedDB "+a.H.aa+" to v"+a.H.VERSION+"...");f=null===(g=f.target)||void 0===g?void 0:g.result;for(var h in a.H.N)g=h,a.H.N.hasOwnProperty(h)&&!f.objectStoreNames.contains(a.H.N[g])&&f.createObjectStore(a.H.N[g])};e.onsuccess=function(f){var g,h=null===(g=f.target)||void 0===g?void 0:g.result;h.onversionchange=function(){h.close();
...
d.H.aa)}})};var Ha={xa:{aa:"AppboyServiceWorkerAsyncStorage",VERSION:6,N:{Ra:"data",wf:"pushClicks",$d:"pushSubscribed",bi:"fallbackDevice",Ig:"cardUpdates",Yd:"optOut",uf:"pendingData",zf:"sdkAuthenticationSignature"},Wc:1}};var Ia={Oh:"allowCrawlerActivity",Sh:"baseUrl",li:"noCookies",Mg:"devicePropertyAllowlist",Yh:"disablePushTokenMaintenance",$h:"enableLogging",ai:"enableSdkAuthentication",ki:"manageServiceWorkerExternally",gi:"minimumIntervalBetweenTriggerActionsInSeconds",wi:"sessionTimeoutInSeconds",Qh:"appVersion",Rh:"appVersionNumber",ti:"serviceWorkerLocation",ri:"safariWebsitePushId",ji:"localization",Vh:"contentSecurityNonce",Ph:"allowUserSuppliedJavascript",ii:"inAppMessageZIndex",ni:"openInAppMessagesInNewTab",
...
b?(u.error("Cannot set last-known location - latitude and longitude are bounded by \u00b190 and \u00b1180 respectively."),!1):null!=c&&0>c||null!=e&&0>e?(u.error("Cannot set last-known location - accuracy and altitudeAccuracy may not be negative."),!1):this.G.Re(this.o.X(),a,b,d,c,e).B};
...
var Ib={MALE:"m",FEMALE:"f",OTHER:"o",UNKNOWN:"u",NOT_APPLICABLE:"n",PREFER_NOT_TO_SAY:"p"},Jb={OPTED_IN:"opted_in",SUBSCRIBED:"subscribed",UNSUBSCRIBED:"unsubscribed"},Kb=/^[0-9 .\\(\\)\\+\\-]+$/,Ob="subscribed",Pb="unsubscribed",Qb=33;function Sb(){}Sb.prototype.ye=function(){};Sb.prototype.Ae=function(){};Sb.prototype.$a=function(){};function Tb(a,b){if(a&&b)if(a=a.toLowerCase(),v(b.R))for(var c=0;c<b.R.length;c++){if(-1!==a.indexOf(b.R[c].toLowerCase()))return b.U}else if(-1!==a.indexOf(b.R.toLowerCase()))return b.U};var Ub={cf:"Chrome",Md:"Edge",sf:"Opera",be:"Safari",ci:"Firefox"};function Vb(){this.userAgentData=navigator.userAgentData;this.version=this.nb=null;if(this.userAgentData){var a=this.userAgentData.brands;if(a&&a.length){a=r(a);for(var b=a.next();!b.done;b=a.next()){b=b.value;var c=void 0,d=[];for(c in Ub)d.push(Ub[c]);if((c=b.brand.match(new RegExp("("+d.join("|")+")","i")))&&0<c.length){var e=c[0];var f=b.version;break}}}this.nb=e||"Unknown Browser";this.version=f||"Unknown Version"}this.ta=null}ta(Vb,Sb);Vb.prototype.ye=function(){return this.nb};
...
function hc(a){var b=Na(O),c;b=r(b);for(c=b.next();!c.done;c=b.next()){var d=c.value;c=gc(a,O[d]);null!=c&&ec(a,O[d],c)}}function ic(a,b){if(null==b||0===b.length)return!1;b=v(b)?b:[b];var c=a.$.oa(E.Fc);null!=c&&v(c)||(c=[]);for(var d=0;d<b.length;d++)c.push(b[d].A());return a.$.store(E.Fc,c)}
function jc(a){var b=a.$.oa(E.Fc);a.$.remove(E.Fc);null==b&&(b=[]);a=[];var c=!1,d=null;if(v(b))for(var e=0;e<b.length;e++)hb(b[e])?a.push(ib(b[e])):d=e;else c=!0;if(c||null!=d)e="Stored events could not be deserialized as Events",c&&(e+=", was "+Object.prototype.toString.call(b)+" not an array"),null!=d&&(e+=", value at index "+d+" does not look like an event"),e+=", serialized values were of type "+typeof b+": "+JSON.stringify(b),a.push(new gb(null,"ie",(new Date).valueOf(),null,{e:e}));return a}
function M(a,b,c){return Ka(E,b,"StorageManager cannot store object.","STORAGE_KEYS.OBJECTS")?a.$.store(b,c):!1}function D(a,b){return Ka(E,b,"StorageManager cannot retrieve object.","STORAGE_KEYS.OBJECTS")?a.$.oa(b):!1}function P(a,b){Ka(E,b,"StorageManager cannot remove object.","STORAGE_KEYS.OBJECTS")&&a.$.remove(b)}bc.prototype.clearData=function(){for(var a=Na(O),b=Na(E),c=0;c<a.length;c++)this.pc.remove(O[a[c]]);for(a=0;a<b.length;a++)this.$.remove(E[b[a]])};
function kc(a,b){var c=a.$.oa(E.ib);null==c&&(c={});var d=b.user_id||E.Gd,e=c[d],f;for(f in b)"user_id"!==f&&(null==c[d]||e&&null==e[f])&&lc(a,b.user_id,f,b[f])}function lc(a,b,c,d){var e=a.$.oa(E.ib);null==e&&(e={});var f=b||E.Gd,g=e[f];null==g&&(g={},null!=b&&(g.user_id=b));if("custom"===c){null==g[c]&&(g[c]={});for(var h in d)g[c][h]=d[h]}else g[c]=d;e[f]=g;return a.$.store(E.ib,e)}function mc(a){var b=a.$.oa(E.ib);a.$.remove(E.ib);a=[];for(var c in b)null!=b[c]&&a.push(b[c]);return a}
...
function Hc(a,b,c,d){c=void 0===c?!1:c;d=xc(a.la,!(void 0===d?0:d));var e=d.ad(),f=D(a.h,E.Lc);Oa(f,e)||(b.device=e);b.api_key=a.O;b.time=Pa((new Date).valueOf(),!0);e=D(a.h,E.Af)||[];f=D(a.h,E.Df)||"";0<a.yc.length&&(!Oa(e,a.yc)||f!==Ic(a.I))&&(b.sdk_metadata=a.yc);b.sdk_version=a.Bb;a.Ab&&(b.sdk_flavor=a.Ab);b.app_version=a.appVersion;b.app_version_code=a.Kf;b.device_id=d.id;d=a.o.X();c&&null!==d&&(b.user_id=d);d||a.F.Ea||(a=fb(a.h))&&(b.alias=a);return b}
...
function Pc(a,b){var c="HTTP error ";null!=a&&(c+=a+" ");u.error(c+b)}function Nc(a,b){var c={};b&&(c.triggers=!0);(b=a.o.X())&&(c.user_id=b);c.user_id||a.F.Ea||(b=fb(a.h))&&(c.alias=b);c.config={config_time:R(a.j).wb};return{respond_with:c}}
...
n.ca=function(){this.Ke.Y();this.F.oh.Y();td(this);this.hd=!0;od(this,void 0,!1,void 0,void 0,void 0,void 0,!0);this.oc=null;this.xe=!1};function ud(a,b){return a.xe?(b(),null):Ta(a.Ke,b)}
...
n.Ia=function(a,b,c){var d=this.o.X();if(d!==a){var e=this.I,f=gc(e.h,O.lb);null!=f&&(e.h.pc.remove(O.lb),f=yd(e,(new Date).valueOf(),f),null==f||ic(e.h,[f]));P(this.h,E.Od);P(this.h,E.Fb);P(this.h,E.$b);null!=d&&od(this,void 0,!1);e=this.o;f=null==e.X();ec(e.h,O.Yc,new kb(a));if(f){e=e.h;f=e.$.oa(E.ib);if(null!=f){var g=E.Gd,h=f[g];null!=h&&(f[g]=void 0,e.$.store(E.ib,f),h.user_id=a,kc(e,h))}g=gc(e,O.lb);f=null;null!=g&&(f=g.za);g=jc(e);if(null!=g)for(h=0;h<g.length;h++){var k=g[h];null==k.hb&&k.sessionId==
...
n.Re=function(a,b,c,d,e,f){b={latitude:b,longitude:c};null!=d&&(b.altitude=d);null!=e&&(b.ll_accuracy=e);null!=f&&(b.alt_accuracy=f);(a=L("lr",b,a||void 0))&&u.info("Set user last known location as "+JSON.stringify(b,null,2));return a};function Bd(a,b,c){var d=wd(a.I);return new gb(a.o.X(),"pc",b,d,{cid:c})}function Rb(a){var b=Ha.xa;(new Aa(b)).setItem(b.N.Ra,1,{baseUrl:a.ia,data:{api_key:a.O,device_id:xc(a.la).id},userId:a.o.X(),sdkAuthEnabled:a.F.Ea})};function pd(a,b,c,d,e,f,g,h,k,l){a=void 0===a?0:a;b=void 0===b?[]:b;c=void 0===c?[]:c;d=void 0===d?[]:d;e=void 0===e?null:e;g=void 0===g?{enabled:!1}:g;h=void 0===h?{enabled:!1,Ei:void 0}:h;k=void 0===k?{enabled:!0,capacity:30,refill_rate:30,endpoint_overrides:{}}:k;l=void 0===l?null:l;this.wb=a;this.we=b;this.je=c;this.Ne=d;this.Ie=e;this.Ib=g;this.ma=h;this.sb=k;this.va=l;this.wb=a;this.we=b;this.je=c;this.Ne=d;this.Ie=e;this.Fa=void 0===f?null:f;this.Ib=g;this.ma=h;this.sb=k;this.va=l}
pd.prototype.A=function(){return{s:"6.2.0",l:this.wb,e:this.we,a:this.je,p:this.Ne,m:this.Ie,v:this.Fa,c:this.Ib,f:this.ma,grl:this.sb,b:this.va}};function Cd(a){this.h=a;this.Ye=new w;this.Tf=new w;this.Zf=new w;this.Nf=new w;this.Bd=this.qe=null}function R(a){if(null==a.Bd){var b=D(a.h,E.Cf);if(null!=b){var c=b.l;"6.2.0"!==b.s&&(c=0);b=new pd(c,b.e,b.a,b.p,b.m,b.v,b.c,b.f,b.grl,b.b)}else b=new pd;a.Bd=b}return a.Bd}function Dd(a,b){b=Ta(a.Ye,b);a.qe&&a.Ye.fa(a.qe);a.qe=b}function Ed(a,b){Ta(a.Tf,b)}function Fd(a,b){return Ta(a.Zf,b)}function Gd(a,b){Ta(a.Nf,b)}function Mb(a,b){return-1!==R(a).je.indexOf(b)}
...
pa;this.language=fa;this.altImageText=Eb;this.gg=this.tb=this.ub=this.Wf=!1;this.Me=this.rc=null;this.ka=new w;this.jd=new w;this.gd=Sd.CENTER}n=S.prototype;n.Bc=function(a){return Ta(this.ka,a)};n.Ve=function(a){return Ta(this.jd,a)};n.fa=function(a){this.ka.fa(a);this.jd.fa(a)};n.Y=function(){this.ka.Y();this.jd.Y()};n.Sf=function(){$d(this,this.rc)};n.vb=function(){return!0};n.Dg=function(){return this.vb()};function ae(a){return null!=a.htmlId&&4<a.htmlId.length}
...
arguments;Promise.resolve(Af).then(function(B){F.V?B.Qb.apply(B,ba(Array.prototype.slice.call(z))):u.error("Braze must be initialized before calling methods.")})}}for(var h={display:{},web:{}},k={requestImmediateDataFlush:function(){var z=arguments;Promise.resolve(Gf).then(function(B){B=B.vc;F.V?B.apply(null,ba(Array.prototype.slice.call(z))):u.error("Braze must be initialized before calling methods.")})},logCustomEvent:function(){var z=arguments;Promise.resolve(zf).then(function(B){B=B.qc;F.V?B.apply(null,
ba(Array.prototype.slice.call(z))):u.error("Braze must be initialized before calling methods.")})},logPurchase:function(){var z=arguments;Promise.resolve(Hf).then(function(B){B=B.mh;F.V?B.apply(null,ba(Array.prototype.slice.call(z))):u.error("Braze must be initialized before calling methods.")})},unregisterPush:function(){var z=arguments;Promise.resolve(If).then(function(B){B=B.Nh;F.V?B.apply(null,ba(Array.prototype.slice.call(z))):u.error("Braze must be initialized before calling methods.")})},requestPushPermission:g(),
changeUser:function(){var z=arguments;Promise.resolve(Jf).then(function(B){B=B.Ia;F.V?B.apply(null,ba(Array.prototype.slice.call(z))):u.error("Braze must be initialized before calling methods.")})}},l=r(Na(k)),m=l.next();!m.done;m=l.next())m=m.value,h[m]=f(m);m="setFirstName setLastName setEmail setGender setDateOfBirth setCountry setHomeCity setEmailNotificationSubscriptionType setLanguage addAlias setPushNotificationSubscriptionType setPhoneNumber setCustomUserAttribute addToCustomAttributeArray removeFromCustomAttributeArray incrementCustomUserAttribute setCustomLocationAttribute addToSubscriptionGroup removeFromSubscriptionGroup setLineId".split(" ");
...
b[T.sa],b[T.qa])}c&&a.h&&P(a.h,E.$b);return c};var sf={W:null,C:!1,P:function(){sf.ba();sf.W||(sf.W=new fg);return sf.W},ba:function(){sf.C||(ag(sf),sf.C=!0)},ca:function(){sf.W=null;sf.C=!1}};function mg(a,b,c,d,e){this.Ze=b;this.Ec=c;this.Vb=a;this.Ze=b;this.Ec=c;this.rd=d;this.Ma=e}function ng(a,b,c,d,e){return null==a||null==a.trigger_id?null:new mg(a.trigger_id,b,c,d,e)};function og(a,b,c,d,e){this.pg=a;this.Ba=b;this.Ce=e;this.pg=a;this.Ba=b;this.h=c;this.G=d;this.Ce=e;this.kd=[];this.La=[];this.bb=null;this.T={};this.na={};this.pa=[];this.Ed=0;pg(this);qg(this)}ta(og,tc);function rg(a){if(a.h){a.bb=D(a.h,E.Vd)||a.bb;a.T=D(a.h,E.lc)||a.T;a.na=D(a.h,E.Rc)||a.na;for(var b=0;b<a.pa.length;b++){var c=a.pa[b];c.id&&null!=a.na[c.id]&&(c.Ka=a.na[c.id])}}}
...
new cf(g,h,k,l,m,q,z,p,t,x,f):null){g.id&&null!=this.na[g.id]&&(g.Ka=this.na[g.id],c[g.id]=this.na[g.id]);g.id&&null!=this.T[g.id]&&(d[g.id]=this.T[g.id]);for(h=0;h<g.pb.length;h++)if(af(g.pb[h],Ze.ha,null)){b=!0;break}this.pa.push(g)}}Oa(this.na,c)||(this.na=c,this.h&&M(this.h,E.Rc,this.na));Oa(this.T,d)||(this.T=d,this.h&&M(this.h,E.lc,this.T));if(this.h){a=[];for(c=0;c<this.pa.length;c++)a.push(this.pa[c].A());this.Ed=(new Date).valueOf();M(this.h,E.ee,a);M(this.h,E.fe,this.Ed)}b&&(u.info("Trigger with test condition found, firing test."),
...
a+"."),tg(this,x,e,a,c,k),0===x.Ya?sg(this,x,e,a,c,k):this.La.push(window.setTimeout(function(){sg(d,x,e,a,c,k)},1E3*x.Ya)))}}};og.prototype.Ia=function(a){a=void 0===a?!1:a;this.pa=[];this.h&&P(this.h,E.ee);if(!a){this.kd=[];this.bb=null;this.na={};this.T={};for(a=0;a<this.La.length;a++)clearTimeout(this.La[a]);this.La=[];this.h&&(P(this.h,E.Vd),P(this.h,E.Rc),P(this.h,E.lc))}};
og.prototype.clearData=function(){this.pa=[];this.bb=null;this.na={};this.T={};for(var a=0;a<this.La.length;a++)clearTimeout(this.La[a]);this.La=[]};function ug(a,b,c,d){if(null==a.bb)return!0;if(d===Ze.ha)return u.info("Ignoring minimum interval between trigger because it is a test type."),!0;b=b.Je;null==b&&(b=a.pg);return c-a.bb>=1E3*b}
function tg(a,b,c,d,e,f){rg(a);b.id&&(a.T[b.id]=a.T[b.id]||[]);var g={};g.rd=c;g.Cg=d;var h;null!=e&&(h=e.A());g.ie=h;c=[];f=r(f);for(d=f.next();!d.done;d=f.next())d=d.value,d.id&&c.push(d.id);g.pd=c;b.id&&a.T[b.id].push(g);a.h&&M(a.h,E.lc,a.T)};var V={C:!1,L:null,K:function(){V.ba();V.L||V.Hf();return V.L},Hf:function(){if(!V.L){var a=F.options[vg];var b=sf.P().ga;V.L=new og(null!=a?a:30,b,F.h,F.G,sf.P());wg(V.L)}},ba:function(){V.C||(V.Hf(),ag(V),V.C=!0)},ca:function(){V.L=null;V.C=!1}};function xg(a,b,c,d,e){this.endpoint=a;this.oe=b;this.publicKey=c;this.Eg=d;this.Fa=e;this.endpoint=a||null;this.oe=b||null;this.publicKey=c||null;this.Eg=d||null;this.Fa=e||null}xg.prototype.A=function(){return{e:this.endpoint,c:this.oe,p:this.publicKey,u:this.Eg,v:this.Fa}};function yg(a,b){this.j=a;this.h=b}yg.prototype.X=function(){var a=gc(this.h,O.Yc);if(null==a)return null;var b=a.za,c=mb(b);if(997<c){for(;997<c;)b=b.slice(0,b.length-1),c=mb(b);a.za=b;ec(this.h,O.Yc,a)}return b};yg.prototype.Sb=function(a,b){if(Mb(this.j,a))return u.info('Custom Attribute "'+a+'" is blocklisted, ignoring.'),!1;var c={};c[a]=b;return N(this,"custom",c,!0)};
function N(a,b,c,d,e){d=void 0===d?!1:d;e=void 0===e?!1:e;a=lc(a.h,a.X(),b,c);var f="",g=c;d&&(f=" custom","object"===typeof c&&(b=Object.keys(c)[0],g=c[b],"object"===typeof g&&(g=JSON.stringify(g,null,2))));!e&&a&&u.info("Logged"+f+" attribute "+b+" with value "+g);return a}
...
function(f){if(c.V)for(var g=r(c.yb),h=g.next();!h.done;h=g.next())h.value.ab(f)},this.F,this.D);this.G.initialize();b||hc(this.h);u.info('Initialized for the Braze backend at "'+this.options.baseUrl+'" with API key "'+this.O+'".');V.ba();Fd(this.j,function(){var f;c.V&&(null===(f=c.j)||void 0===f?0:qd(f))&&Promise.resolve(Ag).then(function(g){c.V&&(g=g.default,g())})});ud(this.G,function(){var f;c.V&&(null===(f=c.j)||void 0===f?0:qd(f))&&Promise.resolve(Ag).then(function(g){c.V&&(g=g.default,g(void 0,
void 0,!0))})});y(this.bh,this.options);this.V=!0;window.dispatchEvent(new CustomEvent("braze.initialized"));return!0};
zg.prototype.ca=function(a){u.ca();if(this.V){y(this.se);this.se.Y();for(var b=r(this.od),c=b.next();!c.done;c=b.next())c.value.ca();this.od=[];b=r(this.yb);for(c=b.next();!c.done;c=b.next())c.value.clearData(!1);this.D&&Sc(this.D);this.yb=[];this.Y();this.ga=[];null!=this.G&&this.G.ca();this.o=this.I=this.j=this.D=this.la=this.F=this.G=null;this.options={};this.Ab=void 0;this.Kb=this.V=!1;a&&(this.h=null)}};
...
function Ig(a){return a[A.xf]?null:Hg(a[A.Ta],a[A.TYPE],a[A.Ua],a[A.mb],a[A.ra],a[A.jb],Qa(a[A.ya]),a[A.wa]===$a?null:Qa(a[A.wa]),a[A.URL],a[A.kb],a[A.Na],a[A.ea],a[A.Ga],a[A.Sa],a[A.Oa],a[A.ha]||!1,a[A.sa],a[A.qa])};function Jg(a,b,c,d,e){var f=this;this.o=a;this.h=b;this.j=c;this.Jf=d;this.D=e;this.o=a;this.h=b;this.j=c;this.Jf=d;this.D=e;this.Ba=new w;gg(F,this.Ba);this.Ca=this.cb=0;this.S=[];Kg(this);a=Ha.xa;Ga(new Aa(a),a.N.Ig,function(g){var h;if(Lg(f)){Kg(f);var k=f.S.slice();var l=null===(h=f.o)||void 0===h?void 0:h.X();for(h=0;h<g.length;h++)if(l===g[h].userId||null==l&&null==g[h].userId){for(var m=g[h].card,p=null,q=0;q<f.S.length;q++)if(m.id===f.S[q].id){p=f.S[q];break}if(null==p)m=Ig(m),null!=m&&k.push(m);
else if(!Za(p,m))for(p=0;p<k.length;p++)if(m.id===k[p].id){k.splice(p,1);break}}f.S=Mg(f,Ng(f,k,!1));Og(f);y(f.Ba,Pg(f,!0))}});this.lh=this.Ad=this.sc=this.kg=null;this.ve=10}ta(Jg,tc);n=Jg.prototype;n.Se=function(a){this.sc=a};
function Kg(a){if(a.h){for(var b=D(a.h,E.Fb)||[],c=[],d=0;d<b.length;d++){var e=b[d];e=Hg(e[C.Ta],e[C.TYPE],e[C.Ua],e[C.mb],e[C.ra],e[C.jb],Sa(e[C.ya]),Sa(e[C.wa]),e[C.URL],e[C.kb],e[C.Na],e[C.ea],e[C.Ga],e[C.Sa],e[C.Oa],e[C.ha]||!1,e[C.sa],e[C.qa])||void 0;null!=e&&c.push(e)}a.S=Mg(a,Ng(a,c,!1));a.cb=D(a.h,E.Kc)||a.cb;a.Ca=D(a.h,E.Zb)||a.Ca}}
n.ab=function(a){if(Lg(this)&&null!=a&&a.cards){this.h&&M(this.h,E.Bf,F.Bb);var b=a.full_sync;b||Kg(this);var c=a.cards,d=a.last_full_sync_at;a=a.last_card_updated_at;b=void 0===b?!1:b;d=void 0===d?0:d;a=void 0===a?0:a;if(b){var e=[];for(var f=r(this.S),g=f.next();!g.done;g=f.next())g=g.value,g.test&&e.push(g)}else e=this.S.slice();for(f=0;f<c.length;f++){g=c[f];for(var h=null,k=0;k<this.S.length;k++)if(g.id===this.S[k].id){h=this.S[k];break}if(b)g=Ig(g),null!=h&&h.viewed&&g&&(g.viewed=!0),null!=
g&&e.push(g);else if(null==h)g=Ig(g),null!=g&&e.push(g);else if(!Za(h,g))for(h=0;h<e.length;h++)if(g.id===e[h].id){e.splice(h,1);break}}this.S=Mg(this,Ng(this,e,b));Og(this);this.cb=d;this.Ca=a;this.h&&(M(this.h,E.Kc,this.cb),M(this.h,E.Zb,this.Ca));y(this.Ba,Pg(this,!0))}};
...
function Og(a){for(var b,c=[],d=0;d<a.S.length;d++)c.push(a.S[d].A());null===(b=a.h)||void 0===b?void 0:M(b,E.Fb,c)}function Qg(a){a.Ad&&(clearTimeout(a.Ad),a.Ad=null)}
...
function Pg(a,b){b||Kg(a);b=Mg(a,a.S);b.sort(function(d,e){return d.pinned&&!e.pinned?-1:e.pinned&&!d.pinned?1:d.updated&&e.updated&&d.updated>e.updated?-1:d.updated&&e.updated&&e.updated>d.updated?1:0});var c=Math.max(a.Ca||0,a.cb||0);0===c&&(c=void 0);a.h&&D(a.h,E.Zb)===a.Ca&&void 0===c&&(c=a.Ca);return new Tg(b,Qa(c))}n.Cc=function(a){return Ta(this.Ba,a)};function Sg(a){a.cb=0;a.Ca=0;a.h&&(P(a.h,E.Kc),P(a.h,E.Zb))}
n.Ia=function(a){a||(this.S=[],y(this.Ba,new Tg(this.S.slice(),null)),this.h&&(P(this.h,E.Fb),P(this.h,E.Db),P(this.h,E.Eb),P(this.h,E.Qa)));Qg(this);Sg(this)};n.clearData=function(a){this.Ca=this.cb=0;this.S=[];y(this.Ba,new Tg(this.S.slice(),null));a&&this.h&&(P(this.h,E.Fb),P(this.h,E.Db),P(this.h,E.Eb),P(this.h,E.Qa),P(this.h,E.Kc),P(this.h,E.Zb));Qg(this)};function Lg(a){return a.j?R(a.j).Ib.enabled?!0:(0!==R(a.j).wb&&(y(a.Ba,new Tg([],new Date)),a.h&&P(a.h,E.Fb)),!1):!1};var Ug={C:!1,L:null,K:function(){Ug.ba();Ug.L||(Ug.L=new Jg(F.o,F.h,F.j,cg(),F.D),wg(Ug.L));return Ug.L},ba:function(){Ug.C||(ag(Ug),Ug.C=!0)},ca:function(){Ug.L=null;Ug.C=!1}};function Vg(a,b){if(U(F))return Rg(Ug.K(),a,b,!0)};function Tg(a,b){this.cards=this.S=a;this.lastUpdated=b}Tg.prototype.$g=function(){for(var a=0,b=r(this.cards),c=b.next();!c.done;c=b.next())c=c.value,c.viewed||c instanceof eb||a++;return a};function Wg(a){null!=a&&(a=a.querySelectorAll(".ab-unread-indicator")[0],null==a||a.classList.contains("read")||(a.className+=" read"))}function Xg(a,b){var c=b.querySelectorAll(".ab-image-area");b=0;0<c.length&&(b=c[0].offsetWidth);a=r(a);for(c=a.next();!c.done;c=a.next()){var d=c.value;(c=d.Rf)&&d.imageUrl&&"number"===typeof d.aspectRatio&&(d=b/d.aspectRatio)&&(c.style.height=d+"px")}}
...
e.events,e.attributes)})}}};Z.changeUser=oh;Z.getUser=wf;Z.requestImmediateDataFlush=rh;Z.removeSubscription=Zg;Z.removeAllSubscriptions=function(){U(F)&&F.Y()};Z.logCustomEvent=ph;Z.logPurchase=qh;Z.isPushSupported=function(){if(U(F))return hd()};Z.isPushBlocked=function(){if(U(F))return id()};Z.isPushPermissionGranted=function(){if(U(F))return jd()};Z.requestPushPermission=Ch;Z.unregisterPush=Dh;
...
Z.disableSDK=function(){var a=F.G;a&&a.vc();a=new dc(null,!0);var b=new Date;b.setTime(b.getTime()+6E4*a.Xf);a.store("ab.optOut","This-cookie-will-expire-in-"+b.getFullYear());a=Ha.xa;(new Aa(a)).setItem(a.N.Yd,a.Wc,!0);u.info("disableSDK was called");F.ca(!1);F.Kb=!0};Z.enableSDK=function(){(new dc(null,!0)).remove("ab.optOut");var a=Ha.xa;Fa(new Aa(a),a.N.Yd,a.Wc);u.info("enableSDK was called");F.ca(!1);F.Kb=!1};
...
Z.logCardDismissal=Eg;Z.CaptionedImage=cb;Z.ClassicCard=db;Z.ControlCard=eb;Z.ImageOnly=bb;Z.Card=Ua;Z.Card.prototype.dismissCard=Ua.prototype.Vf;Z.Card.prototype.subscribeToClickedEvent=Ua.prototype.Bc;Z.Card.prototype.subscribeToDismissedEvent=Ua.prototype.Ve;Z.Card.prototype.removeSubscription=Ua.prototype.fa;Z.Card.prototype.removeAllSubscriptions=Ua.prototype.Y;Z.Card.fromContentCardsJson=Ig;Z.requestContentCardsRefresh=Vg;Z.getCachedContentCards=function(){if(U(F))return Pg(Ug.K(),!1)};
...
Z.InAppMessage.SlideFrom=Td;Z.InAppMessage.ClickAction=Ud;Z.InAppMessage.DismissType=Wd;Z.InAppMessage.OpenTarget=Vd;Z.InAppMessage.ImageStyle=Xd;Z.InAppMessage.TextAlignment=Sd;Z.InAppMessage.Orientation=je;Z.InAppMessage.CropType=Zd;Z.InAppMessage.fromJson=ze;Z.InAppMessage.prototype.subscribeToClickedEvent=S.prototype.Bc;Z.InAppMessage.prototype.subscribeToDismissedEvent=S.prototype.Ve;Z.InAppMessage.prototype.removeSubscription=S.prototype.fa;Z.InAppMessage.prototype.removeAllSubscriptions=S.prototype.Y;
Z.InAppMessage.prototype.closeMessage=S.prototype.Sf;Z.InAppMessageButton=re;Z.InAppMessageButton.prototype.subscribeToClickedEvent=re.prototype.Bc;Z.InAppMessageButton.prototype.removeSubscription=re.prototype.fa;Z.InAppMessageButton.prototype.removeAllSubscriptions=re.prototype.Y;Z.BrazeSdkMetadata=nh;Z.DeviceProperties=vc;Z.User=K;Z.User.Genders=Ib;Z.User.NotificationSubscriptionTypes=Jb;Z.User.prototype.getUserId=K.prototype.X;Z.User.prototype.setFirstName=K.prototype.Bh;
